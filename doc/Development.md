# Development and Testing Guide <br/> Sms Settings Microservice Client SDK for Node.ks
...
```bash
git clone git@github.com:pip-services-users/pip-clients-smssettings-node.git
```
